...
penup(),goto(0,-100),pendown(),color('yellow')
write('0 4 2 1',move=False,align='center',font=('Time New Roman',50,'bold'))
penup(),goto(0,-230),pendown(),color('red')
write('猪猪生日快乐',move=False,align='center',font=('黑体',45,'normal'))
hideturtle();mainloop()
